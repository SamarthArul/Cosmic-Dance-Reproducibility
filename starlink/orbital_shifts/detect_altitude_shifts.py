'''
Detects the type of orbital altitude shift using record of altitude over a few days 
and Segregate similar orbital shift into directories
...
if __name__ == '__main__':
    ...
    OUTPUT_DIR = "artifacts/OUTPUT/Starlink/measurement/track_altitude_change/merged_above_ptile_99"
    ...
    INPUT_DIR = "artifacts/OUTPUT/Starlink/measurement/track_altitude_change/merged_above_ptile_99/RAW"
